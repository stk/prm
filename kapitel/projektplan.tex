...
Folgende Kostensätze werden angenommen:
\begin{itemize}
\item 25 Euro für den einfachen Arbeiter
\item 35 Euro für den Denker
\end{itemize}

\subsection{Aufwands- und Kostenschätzung}
\paragraph*{}
Die Kosten für die Hardware betragen laut Tabelle 5 703,62 Euro. Kosten von 8240 Euro für das Personal ergibt sich aus Tabelle 4. Somit entstehen Gesamtkosten von voraussichtlich 8943,62 Euro.

\begin{table}[h]
\caption{Aufwands- und Kostenschätzung}
\begin{tabular}[h]{|p{0,6cm}|p{5cm}|p{4,3cm}|p{2cm}|p{2cm}|}
\hline
\textsc{Nr} & \textsc{Aktivität} & \textsc{Rollen} & \textsc{Aufwand} & \textsc{Kosten}\\
\hline
...
5.1 & Einführung, Übergabe und Schulung & Auftraggeber & 3 Tage & 24 mal 25 Euro\\
\hline
\end{tabular}
\end{table}
...
\hline
\textsc{Beschreibung} & \textsc{Bezeichnung} & \textsc{Stückpreis} & \textsc{Gesamtpreis} & \textsc{Link zum Hersteller}\\
\hline
...
\hline
Türschloss & Kartenleser Kartenschloss Kemo M068 & 7,80 EUR & 7,80 EUR &
...
\hline
Karten für Türschloss & 20x5 Ersatzkarten für Kartenleser Kartenschloss Kemo M068 & 7,99 EUR & 159,80EUR & \url{http://www.luedeke-elektronic.de/products/Elektronik-Module/Sicherheit-Ueberwachung/Kartenleser-Kartenschloss-Kemo-M068.html}\\
\hline
\end{tabular}
}
\end{table}
...
Der Risikoplan ist in Abbildung 1 dargestellt.